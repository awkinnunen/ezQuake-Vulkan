...
macro(add_resources target_var)
    ...
    foreach(source_file ${ARGN})
        ...
        set(resource_source_root "${CMAKE_SOURCE_DIR}")
        if(source_file_relative MATCHES "^\\.\\./")
            file(RELATIVE_PATH source_file_relative "${CMAKE_BINARY_DIR}" "${source_file}")
            set(resource_source_root "${CMAKE_BINARY_DIR}")
        endif()
        ...
        source_group(TREE "${resource_source_root}" PREFIX "Source Files" FILES ${source_file})
